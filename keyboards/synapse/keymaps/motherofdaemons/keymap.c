...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_BASE] = LAYOUT_default(
    ...
    _______, KC_LGUI, KC_LALT, KC_DN_BSPC,    KC_UP_SPC, KC_RALT,   KC_RGUI, KC_RCTL
  ),
 ...
 [_SYM] = LAYOUT_default(
  ...
  [_NAV] = LAYOUT_default(
    QK_BOOT, KC_F1, KC_F2,  KC_F3,  KC_F4,  KC_TRNS, KC_HOME, KC_UP,   KC_END,   KC_PGUP,  KC_BSPC, KC_TRNS,
    KC_TRNS, KC_F4, KC_F5,  KC_F6,  KC_F7,  KC_TRNS, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_TAB,
